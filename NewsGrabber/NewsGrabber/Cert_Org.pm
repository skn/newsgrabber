...
my $localfile = 'Cert_Org';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub Cert_Org_print_news
{
  ...
  $get->update_local_file('http://www.cert.org/channels/certcc.rdf',$update_interval,$localfile);
