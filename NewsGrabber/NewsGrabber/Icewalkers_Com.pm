package NewsGrabber::Icewalkers_Com;
...
my $localfile = 'Icewalkers_Com';  	# The local file where the headlines are stored- a '.out' is automatically added to this
...
sub Icewalkers_Com_print_news
{
  ...
  $get->update_local_file('http://www.icewalkers.com/backend/lastheaders.txt',$update_interval,$localfile);
