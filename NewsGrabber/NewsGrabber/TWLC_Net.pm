...
my $localfile = 'TWLC_Net';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub TWLC_Net_print_news
{
  ...
  $get->update_local_file('http://www.twlc.net/backend.php',$update_interval,$localfile);
