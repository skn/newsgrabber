package NewsGrabber::Mozilla_Org;
...
my $localfile = 'Mozilla_Org';  	# The local file where the headlines are stored -  a '.out' is automatically added to this
...
sub Mozilla_Org_print_news
{
  ...
  $get->update_local_file('http://www.mozilla.org/news.rdf',$update_interval,$localfile);
