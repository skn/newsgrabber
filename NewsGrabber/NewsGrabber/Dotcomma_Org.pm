package NewsGrabber::Dotcomma_Org;
...
my $localfile = 'Dotcomma_Org';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub Dotcomma_Org_print_news
{
  ...
  $get->update_local_file('http://www.dotcomma.org/dotcomma.rdf',$update_interval,$localfile);
