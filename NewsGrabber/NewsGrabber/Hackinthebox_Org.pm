package NewsGrabber::Hackinthebox_Org;
...
my $localfile = 'Hackinthebox_Org';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub Hackinthebox_Org_print_news
{
  shift;
  ...
  $get->update_local_file('http://www.hackinthebox.org/backend.php',$update_interval,$localfile);
