package NewsGrabber::Kuro5hin_Org;
...
my $localfile = 'Kuro5hin_Org';  	# The local file where the headlines are stored- a '.out' is automatically added to this
...
sub Kuro5hin_Org_print_news
{
  ...
  $get->update_local_file('http://www.kuro5hin.org/backend.rdf',$update_interval,$localfile);
