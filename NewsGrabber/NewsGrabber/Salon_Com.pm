...
my $localfile = 'Salon_Com';  	# The local file where the headlines are stored
...
sub Salon_Com_print_news
{
  ...
  $get->update_local_file('http://www.salon.com/feed/RDF/salon_use.rdf',$update_interval,$localfile);
