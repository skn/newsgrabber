package NewsGrabber::Dotcomscoop_Com;
...
my $localfile = 'Dotcomscoop_Com';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub Dotcomscoop_Com_print_news
{
...
shift;
  ...
  $get->update_local_file('http://www.dotcomscoop.com/backend.php',$update_interval,$localfile);
