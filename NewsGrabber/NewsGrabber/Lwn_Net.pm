...
my $localfile = 'Lwn_Net';  	# The local file where the headlines are stored - a '.out' is automatically added to this
...
sub Lwn_Net_print_news
{
  ...
  $get->update_local_file('http://www.lwn.net/headlines/rss',$update_interval,$localfile);
