package NewsGrabber::Betanews_Com;
...
my $localfile = 'Betanews_Com';  	# The local file where the headlines are stored-- a '.out' is automatically added to this
...
sub Betanews_Com_print_news
{
  ...
  $get->update_local_file('http://betanews.com/backend.php3',$update_interval,$localfile);
